...
export const coins: CoinData[] = [
  ...
  },
  {
    ...
    change7d: 3.41,
    change30d: 7.2,
    sparkline30d: genSparkline(0.225, 0.241, 60001, {
      anchors: [
        { t: 0.15, value: 0.218, variance: 0.8 },
        { t: 0.35, value: 0.232, variance: 1.0 },
        { t: 0.55, value: 0.228, variance: 0.9 },
        { t: 0.78, value: 0.238, variance: 0.7 },
      ],
      floor: 0.212,
      ceiling: 0.248,
      roughness: 1.1,
  ...
  },
  {
    ...
    change7d: -10.21,
    change30d: -20.4,
    sparkline30d: genSparkline(2.74, 2.18, 60002, {
      anchors: [
        { t: 0.12, value: 2.81, variance: 1.1 },
        { t: 0.32, value: 2.52, variance: 1.3 },
        { t: 0.54, value: 2.61, variance: 1.0 },
        { t: 0.76, value: 2.28, variance: 1.2 },
      ],
      floor: 2.10,
      ceiling: 2.88,
      roughness: 1.4,
  ...
  },
  {
    ...
    change7d: -1.87,
    change30d: -8.3,
    sparkline30d: genSparkline(3.73, 3.42, 60003, {
      anchors: [
        { t: 0.14, value: 3.82, variance: 0.9 },
        { t: 0.36, value: 3.56, variance: 1.1 },
        { t: 0.58, value: 3.68, variance: 0.8 },
        { t: 0.8, value: 3.38, variance: 1.0 },
      ],
      floor: 3.28,
      ceiling: 3.9,
      roughness: 1.2,
  ...
  },
  {
    ...
    change7d: -4.78,
    change30d: -12.6,
    sparkline30d: genSparkline(0.307, 0.268, 60004, {
      anchors: [
        { t: 0.16, value: 0.312, variance: 0.8 },
        { t: 0.38, value: 0.289, variance: 1.0 },
        { t: 0.56, value: 0.296, variance: 0.9 },
        { t: 0.79, value: 0.274, variance: 0.7 },
      ],
      floor: 0.261,
      ceiling: 0.318,
      roughness: 1.1,
  ...
  },
  {
    ...
    change7d: 1.23,
    change30d: 5.8,
    sparkline30d: genSparkline(0.163, 0.172, 60005, {
      anchors: [
        { t: 0.13, value: 0.158, variance: 1.0 },
        { t: 0.31, value: 0.169, variance: 1.2 },
        { t: 0.52, value: 0.164, variance: 0.9 },
        { t: 0.74, value: 0.175, variance: 1.1 },
      ],
      floor: 0.152,
      ceiling: 0.182,
      roughness: 1.3,
